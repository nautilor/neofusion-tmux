...
# configuration
# @neofusion-continuum-mode default (countdown|time|alert|interval)
# @neofusion-continuum-time-threshold 15

alert_mode="@neofusion-continuum-mode"
time_threshold="@neofusion-continuum-time-threshold"
warn_threshold=360
first_save="@neofusion-continuum-first-save"
